...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoFormat.position'
        db.add_column('portfolio_videoformat', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VideoFormat.position'
        db.delete_column('portfolio_videoformat', 'position')
